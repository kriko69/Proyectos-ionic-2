...
getActivas(){
  ...
  editarCapaci(correo:string,data)
    {
      return this.db.database.ref('/RutasProgramadas/'+correo).update({capacidad:data.capacidad,puntosRecogidas:data.puntosRecogidas});
    }
    //activar Ruta
    quitarRuta(rama)
    {
...
//prueba
    pruebaRef()
    {
        return this.db.list('/Usuario/chris@ucb/FechaIngreso');
    }
    editar(data)
    {
