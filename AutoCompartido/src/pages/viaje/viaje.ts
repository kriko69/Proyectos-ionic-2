...
export class ViajePage {
  ...
  constructor(public navCtrl: NavController,
    public alertCtrl:AlertController, public toast:ToastService,public navParams: NavParams,public modalCtrl:ModalController,public servicio:firebaseService,
...
borrarRutaAgendada(nombre,correo,fecha,hora){
