...
export class AddrutaproPage {
  ...
  vec:any;
  placa;
  constructor(public navCtrl: NavController, public navParams: NavParams,public servicio:firebaseService,public viewCtrl:ViewController
